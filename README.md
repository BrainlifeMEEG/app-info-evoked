...
This Brainlife App reads the .info attribute of a MNE/Evoked instance and outputs it into a .txt file for ease of viewing

# Documentation

#### Input files are:
* a MEG/EEG Raw file in fif format (mne/Evoked).

#### Ouput file is:
  * a .txt file with the .info attribute of the MNE/Evoked instance.
